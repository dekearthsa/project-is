...
featureName = ['Bank','ESlip_Type', 'level', 'page_num', 'block_num'
               , 'par_num', 'line_num','word_num','left','top'
               , 'width', 'height', 'label_index', 'per_word'
               , 'index_order', 'old_label','old_index', 'word'
               , 'label', 'CEng', 'CTha', 'CNum', 'CSym', 'SlipID']
...
df = df[['SlipID', 'Bank', 'level', 'page_num', 'block_num', 
         'par_num', 'line_num', 'left', 'top', 'width', 'height',
         'CEng', 'CTha', 'CNum','CSym', 'word', 'label']]
df = df.rename(columns={"":"ID_column", "SlipID":"Eslip_id"})
df.to_csv('krungsri_data.csv')
