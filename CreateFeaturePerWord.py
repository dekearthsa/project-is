...
#  'ฆ', 'ก', 'ฏ','ด', 'ฌ','ษ', 'ส','ศ', 'ว', 'ซ', 'ง', 'ผ', 'ป','ฉ', 'อ', 'ฮ' , 'ท', 'ม', 'ฒ','ฬ', 'ฝ', 'ฦ', 'ภ', 'ถ', 'ค', 'ต' ,'จ' , 'ข', 'ช','ๆ','ไ','ใ','เ','แ']

arrayThaLang = ['๑','๒','๓','ภ','๔','ถ','ู','ุ','ึ','๕','ค','๖','ต','๗','จ','๘','ข','๙','ช','ๆ','๐','ไ','ำ','ฎ','พ','ฑ','ะ','ธ','ั','ํ','ี','๊','ณ','ร','ฯ','น','ญ','ย'
                 ,'ฐ','บ','ล','ฟ','ฤ','ห','ฆ','ฏ','ก','ด','โ','เ','ฌ','็','้','่','๋','า','ษ','ส','ศ','ว','ซ','ง','ผ','ป','ฉ','แ','อ','ฮ',
                 'ิ','ื','์','ท','ม','ฒ','ใ','ฬ','ฦ','ฝ']
...
print("arrayThaLang ",len(arrayThaLang)) 
# print("arrayThaLang2 ",len(arrayThaLang2)) 
print("arrayEngLang ",len(arrayEngLang)) 
print("arrayNumLang ",len(arrayNumLang)) 
print("arraySymLang ",len(arraySymLang)) 

# df = pd.read_csv('./trainingData/TrainingData.csv')
# df = pd.read_csv("./krungsri_data - krungsri_data.csv")

# df = pd.read_csv("./Kbank_data.csv")
df = pd.read_csv("./krungsri_data.csv")

# df = pd.concat([df_kbank, df_krungsri])
...
dataframe.to_csv('fullword_krungsri.csv')